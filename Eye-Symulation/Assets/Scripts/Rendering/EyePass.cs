...
{
    private EyeFeature.CustomPassSettings settings;
    ...
    public EyePass(EyeFeature.CustomPassSettings settings)
    {
        this.settings = settings;
        //this.renderPassEvent = settings.renderPassEvent;
        if (material == null) material = CoreUtils.CreateEngineMaterial("Shader Graphs/CameraTest");
    }
